...
GROUPS = (
    ...
    ('salary', 'Заработная плата', (
        ...
        ('salary_fazilova', 'Фазилова Ш.Ш'),
        ('salary_arushanyants', 'Арушаньянц Е.Г'),
        ('salary_glukhova', 'Глухова Л.Ю'),
        ('salary_malitsyan', 'Малицян Л.Р'),
        ('salary_sheraliev', 'Шералиев Ш.Т'),
        ('salary_nazarov', 'Назаров Ш.'),
        ('salary_khudaiberganova', 'Худайберганова Ф.'),
        ('salary_radzhapova', 'Раджапова Ш.'),
        ('salary_bekhrul', 'Бехруз'),
        ('salary_videographer', 'Видеооператор'),
    )),
